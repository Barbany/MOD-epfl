...
\begin{enumerate}[label=2.\arabic*]
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=.6\textwidth]{img/lambda_sweep.png}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=\textwidth]{img/psnr_l1.png}
        \includegraphics[width=\textwidth]{img/psnr_tv.png}
